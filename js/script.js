const products = [
  { id: "rally-one", name: "Elite Series Pink", brand: "Elite Padel / Everyday", price: 74.99, type: "Control", gallery: ["images/pink 1.JPG", "images/pink 2.JPG", "images/pink 3.JPG", "images/pink 4.JPG"], color: "#ead8df", accent: "#ef7657", tag: "Best seller", description: "A forgiving all-rounder for building confidence from the first ball to the last." },
